...
INSERT INTO `microprocesseur` (`id`, `marque`, `famille`, `model`, `frequence`, `prix`) VALUES
	(1, 'AMD', 'Ryzen 3', '3200G', 3.6, 99),
	(2, 'AMD', 'Ryzen 5', '3600', 3.6, 129),
	(3, 'AMD', 'Ryzen 5', '5600G', 3.9, 149),
	(4, 'AMD', 'Ryzen 7', '5800X', 3.8, 249),
	(5, 'AMD', 'Ryzen 7', '7800X3D', 4.2, 499),
	(6, 'INTEL', 'Core i5', '13500', 2.5, 139),
	(7, 'INTEL', 'Core i5', '13600K', 3.5, 159),
	(8, 'INTEL', 'Core i7', '13700K', 3.4, 169),
	(9, 'INTEL', 'Core i7', '4790', 3.6, 79);
